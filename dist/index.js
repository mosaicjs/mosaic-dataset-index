...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SearchableDataSet = __webpack_require__(5);

	exports.SearchableDataSet = _interopRequire(_SearchableDataSet);

	var _SearchCriteria = __webpack_require__(6);

	exports.SearchCriteria = _interopRequire(_SearchCriteria);

	var _SearchCriteriaDataSet = __webpack_require__(8);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mosaicAdapters = __webpack_require__(7);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _buildQuery = __webpack_require__(10);

	exports.buildQuery = _interopRequire(_buildQuery);

	var _PrintQueryListener = __webpack_require__(15);

	exports.PrintQueryListener = _interopRequire(_PrintQueryListener);

	var _QueryListener = __webpack_require__(13);

	exports.QueryListener = _interopRequire(_QueryListener);

	var _QueryVisitor = __webpack_require__(11);

	exports.QueryVisitor = _interopRequire(_QueryVisitor);

	var _SearchFunctionBuilder = __webpack_require__(12);

	exports.SearchFunctionBuilder = _interopRequire(_SearchFunctionBuilder);

	var _SerializeQueryListener = __webpack_require__(14);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _QueryVisitor2 = _interopRequireDefault(_QueryVisitor);

	var _SearchFunctionBuilder = __webpack_require__(12);

	var _SearchFunctionBuilder2 = _interopRequireDefault(_SearchFunctionBuilder);

	var _SerializeQueryListener = __webpack_require__(14);

	var _SerializeQueryListener2 = _interopRequireDefault(_SerializeQueryListener);

	function buildQuery(q, options) {
	    var visitor = new _QueryVisitor2['default']();
	    var listener = new _SerializeQueryListener2['default']();
	    visitor.visit(q, listener);
	    q = listener.query;
	    listener = new _SearchFunctionBuilder2['default'](options);
	    visitor.visit(q, listener);
	    var result = listener.query;
	    result.query = q;
	    return result;
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _QueryListener2 = __webpack_require__(13);
